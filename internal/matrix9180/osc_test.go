...
func TestWriteFrame(t *testing.T) {
	layers := []braille.LayerPayload{
		{ID: 1, ZIndex: 10, XOffset: -1, YOffset: 0, Alpha: 160, Data: "R"},
		{ID: 2, ZIndex: 11, XOffset: 0, YOffset: 0, Alpha: 160, Data: "G"},
		{ID: 3, ZIndex: 12, XOffset: 1, YOffset: 0, Alpha: 160, Data: "B"},
	}
